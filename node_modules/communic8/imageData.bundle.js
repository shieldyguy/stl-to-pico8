...
/***/ function(module, exports, __webpack_require__) {
	...
	var COLORS = [[0, 0, 0], [28, 42, 84], [127, 35, 83], [0, 136, 79], [173, 82, 49], [95, 87, 79], [194, 195, 199], [255, 241, 231], [255, 0, 72], [255, 164, 0], [255, 238, 0], [0, 230, 33], [25, 171, 255], [131, 117, 157], [255, 117, 168], [255, 204, 167]];
	...
	var set = (0, _index.RPC)({
	  id: 0,
	  input: [_index.ArgTypes.String],
	  output: []
	});
	var sendImage = (0, _index.RPC)({
	  id: 1,
	  input: [_index.ArgTypes.Array(_index.ArgTypes.Byte), _index.ArgTypes.Byte],
	  output: []
	});
	...
	img.onload = function (e) {
	  ...
	  var data = ctx.getImageData(0, 0, 127, 127).data;
	  var result = [];
	  for (var y = 0; y < 128; y++) {
	    var row = [];
	    for (var x = 0; x < 128; x += 2) {
	      var a = getClosestColor([data[y * 4 * 127 + x * 4], data[y * 4 * 127 + x * 4 + 1], data[y * 4 * 127 + x * 4 + 2]]);
	      var b = getClosestColor([data[y * 4 * 127 + (x + 1) * 4], data[y * 4 * 127 + (x + 1) * 4 + 1], data[y * 4 * 127 + (x + 1) * 4 + 2]]);
	      row.push(a * 16 + b);
	    }
	    bridge.send(sendImage(row, y));
	  }
	};
